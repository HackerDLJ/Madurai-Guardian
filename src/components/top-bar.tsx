    ...
    <header className="sticky top-0 z-40 w-full bg-background/5 backdrop-blur-[32px] px-10 py-6 flex items-center justify-between border-b border-white/10">
      <div className="flex items-center gap-8 flex-1">
        {mounted && state === "collapsed" && (
          <SidebarTrigger className="rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 text-foreground hover:bg-white/10 transition-all duration-500 shadow-xl" />
        )}
        
        {/* Centered Search bar alignment */}
      ...
      <div className="flex items-center gap-6 ml-10">
        <div className="flex items-center gap-3">
          <button className="p-3 rounded-xl hover:bg-white/5 text-muted-foreground/80 hover:text-foreground transition-all relative liquid-glass border-none group">
          ...
          <button className="p-3 rounded-xl hover:bg-white/5 text-muted-foreground/80 hover:text-foreground transition-all liquid-glass border-none group">
