...
export default function Dashboard() {
  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000 pb-20">
      ...
      {/* Stats Grid */}
      <section className="grid grid-cols-1 md:grid-3 gap-10">
      ...
      <section className="pt-12">
        <Card className="rounded-[64px] liquid-glass p-16 relative overflow-hidden group border-white/40 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-start text-left space-y-10">
            ...
            <div className="flex flex-wrap justify-start gap-6 w-full pt-4">
              {socialLinks.map((link) => (
                <Button 
                  ...
                  variant="outline"
                  className={cn(
                    "rounded-[28px] w-24 h-24 bg-white/5 border-white/10 backdrop-blur-xl shadow-lg transition-all duration-500 group/btn flex items-center justify-center",
                    link.color
                  )}
                >
