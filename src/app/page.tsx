...
const socialLinks = [
  { 
    label: "LinkedIn", 
    href: "https://www.linkedin.com/in/luke-jebasundar-46805a364", 
    icon: <Linkedin className="w-10 h-10" />, 
    color: "hover:bg-blue-600 hover:text-white" 
  },
  { 
    label: "GitHub", 
    href: "https://github.com/HackerDLJ", 
    icon: <Github className="w-10 h-10" />, 
    color: "hover:bg-gray-800 hover:text-white" 
  },
  { 
    label: "X", 
    href: "https://x.com/DLJ25961186", 
    icon: (
  ...
  { 
    label: "Telegram", 
    href: "https://t.me/LukeDLJ", 
    icon: <Send className="w-10 h-10" />, 
    color: "hover:bg-blue-400 hover:text-white" 
  },
  { 
    label: "Instagram", 
    href: "https://www.instagram.com/lukedlj", 
    icon: <Instagram className="w-10 h-10" />, 
    color: "hover:bg-pink-600 hover:text-white" 
  },
  { 
    label: "Discord", 
    href: "https://discord.com/users/869597257295609886", 
    icon: (
      <svg viewBox="0 0 24 24" className="w-10 h-10 fill-current">
    ...
    <div className="space-y-12 animate-in fade-in duration-1000 pb-20">
      <header className="md:hidden space-y-6">
        <div className="relative group">
          <Search className="absolute left-6 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground/60 group-focus-within:text-primary transition-colors" />
          <input 
      ...
      <section className="pt-12">
        <Card className="rounded-[64px] liquid-glass p-16 relative overflow-hidden group border-white/40 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col items-start text-left space-y-10">
            ...
            <div className="flex flex-wrap justify-start gap-4 w-full pt-4">
              {socialLinks.map((link) => (
                <Button 
                  ...
                  variant="outline"
                  className={cn(
                    "rounded-[24px] w-24 h-24 bg-white/5 border-white/10 backdrop-blur-xl shadow-lg transition-all duration-500 group/btn flex flex-col items-center justify-center gap-1",
                    link.color
                  )}
                >
                  <a href={link.href} target="_blank" rel="noopener noreferrer" className="flex flex-col items-center justify-center">
                    <div className="flex items-center justify-center p-2">
                      {link.icon}
                    </div>
                    <span className="text-[8px] font-black uppercase tracking-[0.15em] opacity-0 group-hover/btn:opacity-100 transition-opacity mt-1">{link.label}</span>
                  </a>
                </Button>
              ))}
            </div>
